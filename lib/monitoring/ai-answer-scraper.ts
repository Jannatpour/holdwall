...
export interface AIAnswerScrapeOptions {
...
export class AIAnswerScraper {
   ...
   */
  private async scrapeChatGPT(
    options: AIAnswerScrapeOptions
  ): Promise<AIAnswer> {
    const { query } = options;
    ...
    try {
      ...
      throw new Error(
        `ChatGPT scraping failed: ${error instanceof Error ? error.message : "Unknown error"}`
      );
    }
  }
  ...
  private async scrapePerplexity(
    ...
    try {
      ...
      throw new Error(
        `Perplexity scraping failed: ${error instanceof Error ? error.message : "Unknown error"}`
      );
    }
  }
  ...
  private async scrapeGemini(
    ...
    try {
      ...
      throw new Error(
        `Gemini scraping failed: ${error instanceof Error ? error.message : "Unknown error"}`
      );
    }
  }
  ...
  private async scrapeClaude(
    ...
    try {
      ...
      throw new Error(
        `Claude scraping failed: ${error instanceof Error ? error.message : "Unknown error"}`
      );
    }
  }
   ...
   */
  private analyzeTone(text: string): AIAnswer["tone"] {
   ...
   */
  async scrape(options: AIAnswerScrapeOptions): Promise<AIAnswer> {
   ...
   */
  async queryMultipleEngines(
    query: string,
    engines: Array<"chatgpt" | "perplexity" | "gemini" | "claude"> = ["perplexity", "gemini"]
  ): Promise<AIAnswer[]> {
