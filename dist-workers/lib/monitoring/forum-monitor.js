...
class ForumMonitor {
     ...
     * Monitor HackerNews
     */
    async monitorHackerNews(options) {
        const posts = [];
     ...
     */
    async monitorStackOverflow(options) {
        const posts = [];
        const { query, subforum, maxPosts = 50 } = options;
        try {
            let url;
    ...
    async monitor(options) {
        ...
        switch (forum) {
            ...
            case "generic":
                return await this.monitorGeneric(options);
            default:
     ...
     */
    async monitorMultipleForums(brandName, forums = ["reddit", "hackernews"], maxPostsPerForum = 20) {
        const allPosts = [];
...
exports.ForumMonitor = ForumMonitor;
