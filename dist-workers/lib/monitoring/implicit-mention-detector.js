...
exports.ImplicitMentionDetector = void 0;
class ImplicitMentionDetector {
    constructor() {
        this.brandNames = new Map(); // brand -> variants
        this.phoneticCache = new Map();
    }
    /**
     * Register a brand and its known variants
     */
    registerBrand(brandName, variants = []) {
     ...
     */
    determineVariantType(variant, original) {
     ...
     */
    extractContext(text, start, end, window) {
     ...
     */
    detectMentionsBatch(texts, options) {
...
exports.ImplicitMentionDetector = ImplicitMentionDetector;
