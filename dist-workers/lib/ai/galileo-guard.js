...
class GalileoGuard {
     ...
     * Detect hallucinations
     */
    async detectHallucination(text, context) {
     ...
     */
    patternBasedHallucinationDetection(text) {
        let score = 0;
...
exports.GalileoGuard = GalileoGuard;
