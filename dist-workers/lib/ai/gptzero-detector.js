...
exports.GPTZeroDetector = void 0;
class GPTZeroDetector {
     ...
     */
    async checkCitations(text, citations) {
        const indicators = [];
...
exports.GPTZeroDetector = GPTZeroDetector;
