...
exports.EscalationChecker = void 0;
...
class EscalationChecker {
    ...
    async check(content, tenantId) {
        try {
            ...
            logger_1.logger.error("Failed to check escalation risk", {
...
exports.EscalationChecker = EscalationChecker;
